...
public class Purple extends GraphicsProgram{
...
//			}
			...
			if (subRegionData != null){
				shape.setFillColor(new Color(subRegionData.getRepublicans()/subRegionData.getTotal(), subRegionData.getOthers()/subRegionData.getTotal(), subRegionData.getDemocrats()/subRegionData.getTotal()));
			}
			else{
